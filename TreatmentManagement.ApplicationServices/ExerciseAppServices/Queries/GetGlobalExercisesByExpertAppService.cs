...
{
	public class GetGlobalExercisesByExpertAppService : IGetGlobalExercisesByExpertAppService
	{
		private readonly IUnitOfWork _unitOfWork;
		public GetGlobalExercisesByExpertAppService(IUnitOfWork unitOfWork)
		{
