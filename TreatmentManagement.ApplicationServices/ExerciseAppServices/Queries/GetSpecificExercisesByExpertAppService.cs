...
{
	public class GetSpecificExercisesByExpertAppService : IGetSpecificExercisesByExpertAppService
	{
		private readonly IUnitOfWork _unitOfWork;
		public GetSpecificExercisesByExpertAppService(IUnitOfWork unitOfWork)
		{
