...
{
	public class AddCollectionByAdminAppService : IAddCollectionByAdminAppService
	{
		private readonly IUnitOfWork _unitOfWork;
		public AddCollectionByAdminAppService(IUnitOfWork unitOfWork)
		{
