...
{
	public class GetCollectionsesPageListByAdminAppService : IGetCollectionsPageListByAdminAppService
	{
		private readonly IUnitOfWork _unitOfWork;
		public GetCollectionsesPageListByAdminAppService(IUnitOfWork unitOfWork)
		{
